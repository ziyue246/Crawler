...
public class SokuVideoSearchXpathExtractor extends VideoSearchXpathExtractor implements VideoSearchExtractorAttribute {
	...
	@Override
	public String templateListPage(List<VideoData> list, HtmlInfo html, int page, String... keyword)
	...
	@Override
	public String templateContentPage(VideoData data, HtmlInfo html, int page, String... keyword) {
		return null;
	}

	@Override
	public void processPage(VideoData data, Node domtree, Map<String, Component> map, String... args) {
		// TODO Auto-generated method stub

	}

	@Override
	public void processList(List<VideoData> list, Node domtree, Map<String, Component> components, String... args) {
		// TODO Auto-generated method stub
