package common.download.video.sub;
 ...
 * @author rzy
 */
public class SokuVideoDataCommonDownload extends GenericDataCommonDownload<SokuVideoData> {

	public SokuVideoDataCommonDownload(String siteFlag, SokuVideoData vd, CountDownLatch endCount, SearchKey key) {
