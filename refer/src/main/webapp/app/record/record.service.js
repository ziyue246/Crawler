...
var RecordService = (function () {
    function RecordService(http) {
        ...
        this.urlGetRecord = 'http://localhost:8080/refer/json_record_query.action'; // URL to web api
    }
    RecordService.prototype.getRecord = function (paperId) {
        return this.http.post(this.urlGetRecord, JSON.stringify({
            paper_id: paperId
        }), { headers: this.headers }).toPromise()
            .then(function (response) { return response.json().record; });
    };
